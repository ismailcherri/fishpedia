...
const styles: Record<CatchStatus, string> = {
  ...
  protected: 'bg-purple-100 text-purple-800 dark:bg-purple-900/60 dark:text-purple-200',
  unregulated: 'bg-slate-200 text-slate-700 dark:bg-slate-700 dark:text-slate-200',
}
