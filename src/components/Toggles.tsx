...
export function RegionToggle() {
  ...
  return (
    <div
      role="group"
      aria-label="Region"
      className="inline-flex rounded-full bg-water-100 p-0.5 dark:bg-water-900"
    >
      {options.map((o) => (
        <button
          key={o.value}
...
export function LangToggle() {
  ...
  return (
    <button
      ...
      className="rounded-full bg-water-100 px-3 py-1.5 text-sm font-semibold text-water-800 transition-colors hover:bg-water-200 dark:bg-water-900 dark:text-water-100 dark:hover:bg-water-800"
