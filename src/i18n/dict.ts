export const dict = {
  appName: { de: 'Fishpidea', en: 'Fishpidea' },
  tagline: {
  ...
  installHint: {
    de: 'Tipp: Über »Zum Startbildschirm hinzufügen« wird Fishpidea zur App und funktioniert auch offline am Wasser.',
    en: 'Tip: Use “Add to Home Screen” to install Fishpidea as an app – it also works offline at the water.',
  },
  footerNote: {
