...
export const cyprinids: FishSpecies[] = [
  {
    id: 'karpfen',
    names: { de: 'Karpfen', en: 'Common Carp', scientific: 'Cyprinus carpio' },
    category: 'cyprinid',
    description: {
  ...
  {
    id: 'ploetze',
    names: { de: 'Plötze (Rotauge)', en: 'Roach', scientific: 'Rutilus rutilus' },
    category: 'cyprinid',
    description: {
  ...
  {
    id: 'rotfeder',
    names: { de: 'Rotfeder', en: 'Rudd', scientific: 'Scardinius erythrophthalmus' },
    category: 'cyprinid',
    description: {
  ...
  {
    id: 'blei',
    names: { de: 'Blei (Brassen)', en: 'Common Bream', scientific: 'Abramis brama' },
    category: 'cyprinid',
    description: {
  ...
  {
    id: 'guester',
    names: { de: 'Güster', en: 'White Bream', scientific: 'Blicca bjoerkna' },
    category: 'cyprinid',
    description: {
  ...
  {
    id: 'karausche',
    names: { de: 'Karausche', en: 'Crucian Carp', scientific: 'Carassius carassius' },
    category: 'cyprinid',
    description: {
  ...
  {
    id: 'giebel',
    names: { de: 'Giebel', en: 'Prussian Carp', scientific: 'Carassius gibelio' },
    category: 'cyprinid',
    description: {
  ...
  {
    id: 'ukelei',
    names: { de: 'Ukelei (Laube)', en: 'Bleak', scientific: 'Alburnus alburnus' },
    category: 'cyprinid',
    description: {
  ...
  {
    id: 'nase',
    names: { de: 'Nase', en: 'Common Nase', scientific: 'Chondrostoma nasus' },
    category: 'cyprinid',
    description: {
