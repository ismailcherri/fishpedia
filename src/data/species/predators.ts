...
export const predators: FishSpecies[] = [
  ...
  {
    id: 'zander',
    names: { de: 'Zander', en: 'Zander / Pikeperch', scientific: 'Sander lucioperca' },
    category: 'predator',
    description: {
  ...
  {
    id: 'barsch',
    names: { de: 'Flussbarsch', en: 'European Perch', scientific: 'Perca fluviatilis' },
    category: 'predator',
    description: {
  ...
  {
    id: 'aal',
    names: { de: 'Europäischer Aal', en: 'European Eel', scientific: 'Anguilla anguilla' },
    category: 'predator',
    description: {
  ...
  {
    id: 'kaulbarsch',
    names: { de: 'Kaulbarsch', en: 'Ruffe', scientific: 'Gymnocephalus cernua' },
    category: 'predator',
    description: {
