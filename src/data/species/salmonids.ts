...
export const salmonids: FishSpecies[] = [
  {
    id: 'bachforelle',
    names: { de: 'Bachforelle', en: 'Brown Trout', scientific: 'Salmo trutta fario' },
    category: 'salmonid',
    description: {
  ...
  {
    id: 'seeforelle',
    names: { de: 'Seeforelle', en: 'Lake Trout', scientific: 'Salmo trutta lacustris' },
    category: 'salmonid',
    description: {
  ...
  {
    id: 'aesche',
    names: { de: 'Äsche', en: 'Grayling', scientific: 'Thymallus thymallus' },
    category: 'salmonid',
    description: {
  ...
  {
    id: 'lachs',
    names: { de: 'Atlantischer Lachs', en: 'Atlantic Salmon', scientific: 'Salmo salar' },
    category: 'salmonid',
    description: {
  ...
  {
    id: 'meerforelle',
    names: { de: 'Meerforelle', en: 'Sea Trout', scientific: 'Salmo trutta trutta' },
    category: 'salmonid',
    description: {
