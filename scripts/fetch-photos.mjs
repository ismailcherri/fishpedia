...
const UA = 'Fishpidea/1.0 (https://github.com/ismailcherri/fishpidea; hobby fishing companion app)'
...
for (const [id, ...titles] of SPECIES) {
  ...
  try {
    ...
    console.log(`ok  ${id}: ${file} (${Math.round(bytes / 1024)} kB, ${credit.license})`)
  } catch (err) {
    failed.push(id)
